...
<main class="main-content">
    ...
    <?php if (!empty($_GET['error'])): ?>
        <div class="alert alert-danger">
            ...
            <div><strong>Gagal</strong><p><?= e($_GET['error']) ?></p></div>
        </div>
    <?php endif; ?>
    ...
    <?php if (!empty($_GET['success'])): ?>
        <div class="alert alert-success">
            <span class="alert-icon">✓</span>
            <div><strong>Berhasil</strong><p><?= e($_GET['success']) ?></p></div>
        </div>
    <?php endif; ?>
    ...
    <div class="card" style="max-width: 550px; margin: 0 auto;">
        <div class="card-header">
            <div>
                ...
                <p class="card-subtitle">Ganti password akun administrator secara berkala untuk menjaga keamanan sistem.</p>
            </div>
        </div>
